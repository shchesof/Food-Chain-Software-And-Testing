...
public abstract class AbstractParty implements Party {
    ...
    // for tests
    public void setCurrentRequestedProduct(Product currentRequestedProduct) {
        this.currentRequestedProduct = currentRequestedProduct;
    }

    public boolean isAttemptToDoubleSpend() {
        return attemptToDoubleSpend;
    }
    ...
    public void setDemoProductsList(List<Product> demoProductsList) {
        this.demoProductsList = demoProductsList;
    }
}