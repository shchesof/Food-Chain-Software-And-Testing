...
public class PorkStrategy extends Strategy {
    ...
    public void initStorageParametres() {
        ...
        product.setStorageParameters(PORK_STORAGE_TIME, PORK_STORAGE_TEMPERATURE,
    ...
    public void initSellerParametres() {
        ...
        product.setSellerParameters(PORK_PACKAGING, PORK_SELLING_PLACE);
    }
    ...
    public void initProcessorParametres() {
        ...
        product.setProcessorParameters(PORK_PROCESSING_TEMPERATURE, PORK_CHEMICAL_PROCESSING_DEGREE);
    }
}