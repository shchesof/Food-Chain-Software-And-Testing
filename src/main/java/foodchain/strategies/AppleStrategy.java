...
public class AppleStrategy extends Strategy {
    ...
    public void initStorageParametres() {
        ...
        product.setStorageParameters(APPLE_STORAGE_TIME, APPLE_STORAGE_TEMPERATURE,
    ...
    public void initSellerParametres() {
        ...
        product.setSellerParameters(APPLE_PACKAGING, APPLE_SELLING_PLACE);
    }
    ...
    public void initProcessorParametres() {
        ...
        product.setProcessorParameters(APPLE_PROCESSING_TEMPERATURE, APPLE_CHEMICAL_PROCESSING_DEGREE);
    }
}